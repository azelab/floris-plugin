...
if ( !class_exists( 'Radium_Theme_Importer' ) ) {
  ...
  class Radium_Theme_Importer {
    ...
    function process_widget_import_file( $file ) {
      ...
      // Get file contents and decode
      global $wpdb;
      $id1 = $wpdb->get_results("SELECT  `post_id` FROM  `wp_postmeta` WHERE  `meta_value` LIKE  '%demos-menu%' LIMIT 0 , 50 ")[0]->post_id;
      $id2 = $wpdb->get_results("SELECT  `post_id` FROM  `wp_postmeta` WHERE  `meta_value` LIKE  '%pages-blog-menu%' LIMIT 0 , 50 ")[0]->post_id;

      $data = '{"sidebar-1":{"search-3":{"title":""},"categories-3":{"title":"Categories","count":1,"hierarchical":0,"dropdown":0},"popularpost-1":{"title":"POPULAR POSTS","posts_per_page":"3"},"tag_cloud-1":{"title":"Popular tags","taxonomy":"post_tag"}},"mega-menu":{"text-2":{"mega_menu_columns":2,"mega_menu_parent_menu_id":'.$id1.',"mega_menu_order":{"'.$id1.'":2},"title":"","text":"<a href=\"#\">FLORIS\r\n<img src=\"http:\/\/floris-export.azelab.com\/wp-content\/uploads\/2016\/06\/floris-menu.jpg\" alt=\"\"><\/a>","filter":false},"text-3":{"mega_menu_columns":2,"mega_menu_parent_menu_id":'.$id1.',"mega_menu_order":{"'.$id1.'":3},"title":"","text":"<a href=\"#\">BOTIQUE\r\n<img src=\"http:\/\/floris-export.azelab.com\/wp-content\/uploads\/2016\/06\/botique.jpg\" alt=\"\"><\/a>","filter":false},"text-4":{"mega_menu_columns":2,"mega_menu_parent_menu_id":'.$id1.',"mega_menu_order":{"'.$id1.'":4},"title":"","text":"<a href=\"#\">CESSORY\r\n<img src=\"http:\/\/floris-export.azelab.com\/wp-content\/uploads\/2016\/06\/cessory.jpg\" alt=\"\"><\/a>","filter":false},"nav_menu-2":{"title":"Prebuilt Layouts","nav_menu":34,"mega_menu_columns":3,"mega_menu_order":{"'.$id2.'":2},"mega_menu_parent_menu_id":'.$id2.'},"nav_menu-3":{"title":"Blog","nav_menu":33,"mega_menu_columns":3,"mega_menu_order":{"'.$id2.'":3},"mega_menu_parent_menu_id":'.$id2.'}}}';
      ...
      $megamenu =  array('type' => 'megamenu');
      update_post_meta( $id1, '_megamenu', $megamenu);
      update_post_meta( $id2, '_megamenu', $megamenu);

      $path_to_file = WP_PLUGIN_DIR.'/megamenu/classes/widget-manager.class.php';
      $file_contents = file_get_contents($path_to_file);
      $file_contents = str_replace('$settings[\'mega_menu_order\'][ $parent_menu_item_id ]','$settings["mega_menu_order"]->$parent_menu_item_id',$file_contents);
